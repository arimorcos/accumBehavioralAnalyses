...
function [prevGUI] = prevEffectGUI()
    ...
    %create plot button
    prevGUI.plotButton = uicontrol('FontName','Arial','FontSize',15,'FontWeight','bold','ForegroundColor',[0 0 0],'Units','Normalized',...
            'Position',[.6 .05 .25 .05],'String','Plot/Update','Style','pushbutton','BackgroundColor',[0.7969 0.7969 0.7969]);
end