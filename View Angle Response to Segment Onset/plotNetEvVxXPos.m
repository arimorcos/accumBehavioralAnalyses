function figH = plotNetEvVsXPos(dataCell,figH,axH,colorToPlot,markerToPlot)
%plotNetEvVsView.m plots net evidence vs. x posiiton at segment offset 
%
%INPUTS
...
%get view angle info
[~,~,segXPos] = findViewAngleChange(dataCell);
...
for condInd = 1:length(netEvConds);
    ...
    %get values
    valsToAverage = segXPos(indToAverage);
