function figH = plotNetEvVsView(dataCell,figH,axH,colorToPlot,markerToPlot)
%plotNetEvVsView.m plots net evidence vs. view angle at segment offset 
%
%INPUTS
...
%get view angle info
[~,segView] = findViewAngleChange(dataCell);
...
for condInd = 1:length(netEvConds);
    ...
    %get values
    valsToAverage = segView(indToAverage);
